...
gulp.task('images', () => {
  gulp.src('_src/images/**/*.+(png|jpg|jpeg|gif|svg)')
    .pipe(cache(imagemin()))
...
gulp.task('browserSync', () => browserSync.init({ server: { baseDir: './dist' } }))
...
gulp.task('build', (callback) => {
  runSequence(['css', 'images', 'js', 'html', 'files'],
    callback
  )
})

gulp.task('default', (callback) => {
  runSequence('syncDist',
